...
var mui = (function(document, undefined) {
    ...
    $.each = function(elements, callback, hasOwnProperty) {
        ...
        if (typeof elements.length === "number") { [].every.call(elements,
            function(el, idx) {
    ...
    $.fn = {
        each: function(callback) { [].every.call(this,
            function(el, idx) {
                return callback.call(el, idx, el) !== false
            });
            return this
    ...
    window.addEventListener($.EVENT_START,
    function(event) {
...
})(mui, window, document); (function(undefined) {
...
function(to) {
    ...
    var convertTouches = function(touches) {
        for (var i = 0; i < touches.length; i++) { ! touches["identifier"] && (touches["identifier"] = 0)
        }
        return touches
    };
    ...
    window.addEventListener($.EVENT_CLICK,
    function(e) {
    ...
    $(function() {
        ...
        if (os.length) {
            $.each(os,
            function(index, osObj) {
                var version = "";
                var classArray = [];
                if (osObj.version) {
                    $.each(osObj.version.split("."),
                    function(i, v) {
            ...
            if (parent) {
                ...
                wobj.canBack(function(e) {
                    if (e.canBack) {
                        ...
                        if (wobj.id === plus.runtime.appid) {} else {
                            if (wobj.preload) {
                                wobj.hide("auto")
                            } else {
                                $.closeAll(wobj)
    ...
    $.Class = Class
})(mui); (function($, document, undefined) {
                    ...
                    if (title !== this.lastTitle) {
                        ...
                        if (isPulldown) {
                            if (title === options.down.contentrefresh) {
                                ...
                                if (title === options.down.contentover) {
                                    loading.className = CLASS_LOADING_UP;
                                    loading.style.webkitTransition = "-webkit-transform 0.3s ease-in";
                                    loading.style.webkitTransform = "rotate(180deg)"
                                } else {
                                    if (title === options.down.contentdown) {
                                        loading.className = CLASS_LOADING_DOWN;
                                        loading.style.webkitTransition = "-webkit-transform 0.3s ease-in";
...
})(mui, document); (function($, window, document, undefined) {
    ...
    var Scroll = $.Class.extend({
        ...
        _drag: function(e) {
            ...
            if (absDeltaX > absDeltaY + this.options.directionLockThreshold) {
                ...
                if (absDeltaY >= absDeltaX + this.options.directionLockThreshold) {
                    deltaX = 0
                }
            }
        ...
        _createScrollBar: function(clazz) {
            ...
            if (clazz === CLASS_SCROLLBAR_VERTICAL) {
                ...
                if (clazz === CLASS_SCROLLBAR_HORIZONTAL) {
...
})(mui, window, document); (function($, window, document, undefined) {
    var CLASS_VISIBILITY = "mui-visibility";
    var CLASS_HIDDEN = "mui-hidden";
        ...
        resetPosition: function(time) {
            if (this.pulldown) {
                if (this.y >= this.options.down.height) {
                    ...
                    return true
                } else { ! this.loading && this.topPocket.classList.remove(CLASS_VISIBILITY)
                }
            }
...
})(mui, window, document); (function($, window) {
    ...
    var Slider = $.Slider = $.Scroll.extend({
        ...
        _triggerSlide: function() {
            ...
            if (self.loop) {
                if (self.slideNumber === 0) {
                    ...
                    if (self.slideNumber === self.itemLength - 3) {
            ...
            if (indicatorWrap) {
                ...
                if (indicators.length > 0) {
                    ...
                    if (number) {
                        ...
                        for (var i = 0,
                        len = controlItems.length; i < len; i++) {
        ...
        handleEvent: function(e) {
            ...
            case "slide":
                this._handleSlide(e);
                break;
            case $.eventName("shown", "tab") : this._handleTabShow(e);
                break
            }
        },
        _scrollend: function(e) {
        ...
        _fixedSlideNumber: function(page) {
            ...
            if (this.loop) {
                if (page.pageX === 0) {
                    ...
                    if (page.pageX === (this.itemLength - 1)) {
                        slideNumber = 0
                    } else {
        ...
        _initPulldownRefreshEvent: function() {
            ...
            if (self.topPocket && self.options.webviewId) {
                $.plusReady(function() {
                    ...
                    webview.addEventListener("dragBounce",
                    function(e) {
                        if (!self.pulldown) {
...
})(mui, document); (function($, window, document, name) {
    var CLASS_OFF_CANVAS_LEFT = "mui-off-canvas-left";
    var CLASS_OFF_CANVAS_RIGHT = "mui-off-canvas-right";
    var CLASS_ACTION_BACKDROP = "mui-off-canvas-backdrop";
    var CLASS_ACTION_BLUE = "mui-border-blue";
    ...
    var OffCanvas = $.Class.extend({
        ...
        refresh: function(offCanvas) {
            ...
            if (offCanvas) {
                if (offCanvas.classList.contains(CLASS_OFF_CANVAS_LEFT)) {
                    ...
                    if (offCanvas.classList.contains(CLASS_OFF_CANVAS_RIGHT)) {
                    ...
                    if (this.slideIn) {
                        ...
                        if (this.classList.contains(CLASS_ACTIVE)) {
                            ...
                            if (detail.direction === "left" && this.offCanvasRight) {
                                ...
                                if (detail.direction === "right" && this.offCanvasLeft) {
                                    this.offCanvas = this.offCanvasLeft;
                                    this.offCanvasWidth = this.offCanvasLeftWidth
                                } else {
                                    this.scroller = null
                        ...
                        if (direction === "right" && ratio >= 0 && (ratio >= 0.5 || detail.swipe)) {
                            ...
                            if (direction === "right" && ratio < 0 && (ratio > -0.5 || detail.swipe)) {
                                ...
                                if (direction === "right" && ratio > 0 && ratio < 0.5) {
                                    ...
                                    if (direction === "right" && ratio < 0.5) {
                                        this.openPercentage( - 100)
                                    } else {
                                        if (direction === "left" && ratio <= 0 && (ratio <= -0.5 || detail.swipe)) {
                                            this.openPercentage( - 100)
                                        } else {
                                            if (direction === "left" && ratio > 0 && (ratio <= 0.5 || detail.swipe)) {
                                                this.openPercentage(0)
                                            } else {
                                                if (direction === "left" && ratio < 0 && ratio >= -0.5) {
                                                    this.openPercentage(0)
                                                } else {
                                                    if (direction === "left" && ratio > 0.5) {
                                                        this.openPercentage(100)
                                                    } else {
                                                        this.openPercentage(0)
                                                    }
                                        ...
                                        if (direction === "left" && ratio >= 0 && (ratio <= 0.5 || detail.swipe)) {
                                            ...
                                            if (direction === "left" && ratio < 0 && (ratio <= -0.5 || detail.swipe)) {
                                                ...
                                                if (direction === "left" && ratio >= 0.5) {
                                                    ...
                                                    if (direction === "left" && ratio >= -0.5 && ratio < 0) {
                                                        this.openPercentage(100)
                                                    } else {
                                                        this.openPercentage(0)
                                                    }
        ...
        initEvent: function() {
            var self = this;
            if (self.backdrop) {
                self.backdrop.addEventListener("tap",
                function(e) {
                    self.close();
        ...
        openPercentage: function(percentage) {
            ...
            if (!this.slideIn) {
                if (this.offCanvasLeft && percentage >= 0) {
                    ...
                    if (this.offCanvasRight && percentage <= 0) {
...
})(mui, window, document, "offcanvas"); (function($, name) {
...
})(mui, "action"); (function($, window, document, name) {
...
})(mui, window, document, "modal"); (function($, window, document, name) {
    ...
    var backdrop = (function() {
        ...
        function(e) {
            ...
            if (popover) {
                ...
                document.querySelector(".mui-border-blue").classList.remove("mui-border-blue")
            }
        });
        return element
    } ());
    ...
    var calPosition = function(popover, anchor, isActionSheet) {
        ...
        if ((pHeight + arrowSize) < (offset.top - window.pageYOffset)) {
            ...
            if ((pHeight + arrowSize) < (wHeight - (offset.top - window.pageYOffset) - aHeight)) {
                position = "bottom";
...
})(mui, window, document, "popover"); (function($, window, document, name, undefined) {
    ...
    function(e) {
        ...
        for (; segmentedControl && segmentedControl !== document; segmentedControl = segmentedControl.parentNode) {
            if (segmentedControl.classList.contains(CLASS_SEGMENTED_CONTROL)) {
                ...
                if (segmentedControl.classList.contains(CLASS_TAB_BAR)) {
        ...
        if (targetTab) {
            ...
            document.querySelector(".clear-all").classList.remove("font-bold");
            segmentedControl.querySelector(".mui-control-item").classList.remove("font-normal");
//            segmentedControl.querySelector(".mui-control-item1").classList.remove("font-normal");
//            segmentedControl.querySelector(".mui-control-item2").classList.remove("font-normal");
            document.querySelector(".mui-control-content").classList.remove("open-block");
//            document.querySelector(".mui-control-content1").classList.remove("open-block");
//            document.querySelector(".mui-control-content2").classList.remove("open-block")
        }
        if (!targetTab.hash) {
            return
        }
...
})(mui, window, document, "tab"); (function($, window, name) {
...
})(mui, window, "toggle"); (function($, window, document) {
    var CLASS_ACTIVE = "mui-active";
    ...
    var updateTranslate = function() {
        if (translateX !== lastTranslateX) {
            if (buttonsRight && buttonsRight.length > 0) {
                ...
                for (var i = 0,
                len = buttonsRight.length; i < len; i++) {
            ...
            if (buttonsLeft && buttonsLeft.length > 0) {
                ...
                for (var i = 0,
                len = buttonsLeft.length; i < len; i++) {
    ...
    window.addEventListener($.EVENT_MOVE,
    function(event) {
        toggleActive(false)
    });
    var handleEvent = {
        ...
        drag: function(event) {
            ...
            if (direction === "left" && (angle > 150 || angle < -150)) {
                ...
                if (direction === "right" && (angle > -30 && angle < 30)) {
        ...
        dragend: function(event) {
            ...
            if (isToggle) {
                if (!isOpened) {
                    ...
                    if (detail.direction === "left" && openedActions === "right") {
                        action = "open"
                    } else {
                        if (detail.direction === "right" && openedActions === "left") {
                            action = "open"
                        }
                    }
                }
    ...
    window.addEventListener($.EVENT_END,
    function(event) {
        if (!cell) {
            return
        }
    ...
    window.addEventListener($.EVENT_CANCEL,
    function(event) {
        if (!cell) {
            return
        }
    ...
    var radioOrCheckboxClick = function(event) {
        ...
        if (classList.contains("mui-radio")) {
            ...
            if (classList.contains("mui-checkbox")) {
    ...
    window.addEventListener("doubletap",
    function(event) {
        if (cell) {
...
})(mui, window); (function($, window, document) {
    ...
    var createPopup = function(html, callback) {
        ...
        popupElement.addEventListener("webkitTransitionEnd",
        function(e) {
    ...
    $.prompt = createPrompt
})(mui, window, document); (function($, window, document) {
    var CLASS_ICON = "mui-icon";
        ...
        if (row) {
            if (self.sliderActionClass) {
                ...
                if (self.searchActionClass) {
                    ...
                    self.searchAction.addEventListener("tap",
                    function(e) {
                        $.focus(self.element);
                        e.stopPropagation()
                    })
                ...
                if (self.speechActionClass) {
                    ...
                    self.speechAction.addEventListener("tap",
                    function(event) {
                ...
                if (self.clearActionClass) {
                    ...
                    self.clearAction.addEventListener("tap",
                    function(event) {
                ...
                if (self.passwordActionClass) {
                    ...
                    self.passwordAction.addEventListener("tap",
                    function(event) {
    ...
    Input.prototype.initElementEvent = function() {
        ...
        if (this.sliderActionClass) {
            ...
            element.addEventListener($.EVENT_MOVE,
            function(e) {
                e.stopPropagation()
            })
        } else {
            if (this.clearActionClass) {
                ...
                function(index, type) { (function(type) {
    ...
    var Numbox = $.Numbox = $.Class.extend({
        ...
        initEvent: function() {
            var self = this;
            self.plus.addEventListener(tapEventName,
            function(event) {
                var val = parseInt(self.input.value) + self.options.step;
                self.input.value = val.toString();
                $.trigger(self.input, changeEventName, null)
            });
            self.minus.addEventListener(tapEventName,
            function(event) {
                var val = parseInt(self.input.value) - self.options.step;
                self.input.value = val.toString();
                $.trigger(self.input, changeEventName, null)
            });
            self.input.addEventListener(changeEventName,
            function(event) {
                self.checkValue();
